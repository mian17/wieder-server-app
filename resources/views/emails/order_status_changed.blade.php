...
Hiện tại, đơn hàng {{$order->uuid}} có thay đổi trạng thái như sau.<br>
Từ trạng thái đơn hàng cũ: <strong>{{$orderStatuses[(int)$oldStatusId - 1]}}</strong> sang trạng thái mới: <strong>{{$orderStatuses[(int)$newStatusId - 1]}}</strong>
