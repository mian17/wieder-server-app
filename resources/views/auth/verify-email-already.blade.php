<head>
    ...
    <title>Đã xác nhận Email</title>
</head>
<body>
<div>
    <header class="site-header" id="header">
        <h1 class="site-header__title" data-lead-id="site-header-title">BẠN ĐÃ XÁC NHẬN EMAIL!</h1>
    </header>

    <div class="main-content">
        <i class="fa fa-check main-content__checkmark" id="checkmark"></i>
        <p class="main-content__body" data-lead-id="main-content-body">
            Bạn đã xác nhận Email thành công, bây giờ bạn có thể mua sắm thoải mái tại Wieder_ Markt.
