...
//            'quantity.max' => 'Số lượng sản phẩm cần dưới 10000',
            ...
            'models.*.name.required' => 'Kiểu loại #:position cần có tên',
            'models.*.name.string' => 'Sai dữ liệu',
            'models.*.name.min' => 'Tên kiểu loại #:position ngắn quá',
            'models.*.name.max' => 'Tên kiểu loại #:position dài quá',
            'models.*.name.unique' => 'Tên kiểu loại #:position này đã tồn tại',

            'models.*.image_1.required' => 'Kiểu loại #:position cần hình cover',
            'models.*.image_1.image' => 'Tập tin của kiểu loại #:position cần có định dạng hình',
            'models.*.image_1.mimes' => 'Tập tin của kiểu loại #:position cần có định dạng hình như sau: png, jpg, jpeg',
            'models.*.image_1.dimensions' => 'Hình của kiểu loại #:position cần phải là tỷ lệ 1:1 để không phá vỡ layout của trang web',
            'models.*.image_1.max' => 'Hình của kiểu loại #:position cần phải bé hơn 2mb',

            'models.*.quantity.required' => 'Kiểu loại #:position cần phải có số lượng',
            'models.*.quantity.integer' => 'Sai dữ liệu',
            'models.*.quantity.numeric' => 'Sai dữ liệu',
            'models.*.quantity.min' => 'Số lượng của kiểu loại #:position phải lớn hơn 1',
            'models.*.quantity.max' => 'Số lượng của kiểu loại #:position phải bé hơn 10000',

            'models.*.image_2.image' => 'Tập tin hình on hover của kiểu loại #:position cần có định dạng hình',
            'models.*.image_2.mimes' => 'Tập tin hình on hover của kiểu loại #:position cần có định dạng hình như sau: png, jpg, jpeg',
            'models.*.image_2.dimensions' => 'Hình của kiểu loại #:position cần phải là tỷ lệ 1:1 để không phá vỡ layout của trang web',
            'models.*.image_2.max' => 'Hình của kiểu loại #:position cần phải bé hơn 2mb',
        ];
    }
}
